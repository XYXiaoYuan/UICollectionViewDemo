...
fileprivate let cellID = "debugNoGapCellID"
...
class DebugNoGapController: UIViewController {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        // 修复宽度
        layout.itemSize = CGSize(width: layout.fixSlit(rect: &rect, colCount: 4), height: 88 * kScreenHScale)
